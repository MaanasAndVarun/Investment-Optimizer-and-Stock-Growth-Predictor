...
def predict_class(sentence, model):
    ...
    f=open('C:/Users/Maanas/Desktop/Codes/Trading-main/r.txt','w')
    #for all guesses
    f1=open('C:/Users/Maanas/Desktop/Codes/Trading-main/s.txt','w')
...
if(a=="Invest"):
    ...
    if(st.sidebar.button("Enter")):
        ...
        invstock_sym=[]
        invstock_name=[]
        f= open("C:/Users/Maanas/Desktop/Codes/Trading-main/Datasets/SP500.csv",'r')
        rd=csv.reader(f)
        for x in rd:
            if x!=[]:
                if x[2]=='badboy':
